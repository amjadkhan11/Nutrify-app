...
const connectToDatabase = async()=>{
    try {
        let connection = await mongoose.connect('mongodb+srv://ashutoshjha123:Ashu123@cluster0.82yympe.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0');
